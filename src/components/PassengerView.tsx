      ...
      <div className="relative w-full bg-white rounded-t-[2.5rem] p-5 space-y-4 shadow-[0_-10px_30px_rgba(0,0,0,0.08)] border-t border-slate-100 z-30 -mt-6">
        ...
        {isActive && (
          <button
            type="button"
            onClick={handleStop}
            className="w-full py-4 bg-rose-600 hover:bg-rose-700 active:bg-rose-800 text-white font-extrabold text-sm rounded-2xl shadow-lg shadow-rose-600/25 transition-all active:scale-[0.98]"
          >
            {t('passenger', 'stop')}
          </button>
        )}
