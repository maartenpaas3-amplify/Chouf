...
export const translations = {
  fr: {
    ...
    driver: {
      ...
      legendFooter: 'Signalements expirés (>15 min) automatiquement masqués.',
      ...
      routeOptimizerTitle: '⚡ Route Optimisée (Max 3)',
      routeOptimizerDesc: 'Trouve les passagers compatibles dans la même direction',
      onboardPassengers: 'Passagers en voiture :',
      seatsAvailable: 'places libres',
      taxiFull: 'Taxi complet (3/3 passagers)',
      noOptimizedRoute: 'Aucun trajet partagé compatible dans la même direction',
      calculateRoute: 'Optimiser la route',
      showRouteOnMap: 'Afficher la route sur la carte',
      hideRouteOnMap: 'Masquer la route',
      startRouteNav: 'Naviguer avec Google Maps',
      navWithGoogleMaps: 'Naviguer avec Google Maps',
      detour: 'Détour estimé',
      totalDist: 'Distance totale',
      pickupStep: 'Ramasser',
      dropoffStep: 'Déposer',
      routeProposed: 'Route suggérée',
      stepLabel: 'ÉTAPE',
      taxiFullShort: 'Complet',
      seat: 'place',
      seats: 'places',
      match: 'correspondance',
      matches: 'correspondances',
      gateTitle: 'Espace Chauffeur',
      gateSubtitle: 'Accès réservé aux chauffeurs Chouf',
      gatePhoneLabel: 'Numéro de téléphone',
      gatePhonePlaceholder: '06 12 34 56 78',
      gateRefCodeLabel: 'Votre code de référence',
      gateOpenWhatsapp: 'Ouvrir WhatsApp',
      gateLogout: 'Se déconnecter',
      gateNote: 'Appuyez sur le bouton WhatsApp pour valider votre demande d\'accès.',
    },
    pwa: {
      installApp: "Installer l'application",
      installTitle: "Installer l'application Chouf",
      installSubtitle: "Ajoutez à l'écran d'accueil sur votre téléphone",
      installBtn: 'Installer',
      addToHome: "Ajouter à l'écran d'accueil",
      howToInstall: 'Comment installer Chouf sur votre téléphone :',
      step1: 'Appuyez sur les 3 points (⋮) en haut à droite dans Chrome.',
      step2: 'Choisissez "Ajouter à l\'écran d\'accueil" ou "Installer".',
  ...
  en: {
    ...
    driver: {
      ...
      legendFooter: 'Expired reports (>15 min) automatically hidden.',
      ...
      routeOptimizerTitle: '⚡ Optimized Route (Max 3)',
      routeOptimizerDesc: 'Finds compatible passengers heading in the same direction',
      onboardPassengers: 'Passengers in car:',
      seatsAvailable: 'seats free',
      taxiFull: 'Taxi full (3/3 passengers)',
      noOptimizedRoute: 'No compatible shared rides in the same direction nearby',
      calculateRoute: 'Optimize route',
      showRouteOnMap: 'Show route on map',
      hideRouteOnMap: 'Hide route',
      startRouteNav: 'Navigate with Google Maps',
      navWithGoogleMaps: 'Navigate with Google Maps',
      detour: 'Estimated detour',
      totalDist: 'Total distance',
      pickupStep: 'Pick up',
      dropoffStep: 'Drop off',
      routeProposed: 'Suggested route',
      stepLabel: 'STEP',
      taxiFullShort: 'Full',
      seat: 'seat',
      seats: 'seats',
      match: 'match',
      matches: 'matches',
      gateTitle: 'Driver Space',
      gateSubtitle: 'Access restricted to Chouf drivers',
      gatePhoneLabel: 'Phone number',
      gatePhonePlaceholder: '06 12 34 56 78',
      gateRefCodeLabel: 'Your reference code',
      gateOpenWhatsapp: 'Open WhatsApp',
      gateLogout: 'Log out',
      gateNote: 'Tap the WhatsApp button to validate your access request.',
    },
    pwa: {
      installApp: 'Install app',
      installTitle: 'Install Chouf App',
      installSubtitle: 'Add to home screen on your phone',
      installBtn: 'Install',
      addToHome: 'Add to Home Screen',
      howToInstall: 'How to install Chouf on mobile:',
      step1: 'Tap the 3 dots (⋮) in top right of Chrome.',
      step2: 'Choose "Add to Home Screen" or "Install".',
      step3: 'Tap "Add".',
  ...
  ar: {
    ...
    driver: {
      ...
      legendFooter: 'يتم إخفاء الطلبات المنتهية (>15 دقيقة) تلقائيا.',
      ...
      routeOptimizerTitle: '⚡ المسار المحسّن (3 ركاب كحد أقصى)',
      routeOptimizerDesc: 'يعثر على الركاب المتوافقين في نفس الاتجاه',
      onboardPassengers: 'الركاب بالسيارة:',
      seatsAvailable: 'مقاعد شاغرة',
      taxiFull: 'التاكسي ممتلئ (3/3 ركاب)',
      noOptimizedRoute: 'لا يوجد مسار مشترك متوافق في نفس الاتجاه بالقرب منك',
      calculateRoute: 'تحسين المسار',
      showRouteOnMap: 'عرض المسار على الخريطة',
      hideRouteOnMap: 'إخفاء المسار',
      startRouteNav: 'التنقل عبر خرائط Google',
      navWithGoogleMaps: 'التنقل عبر خرائط Google',
      detour: 'الانحراف التقديري',
      totalDist: 'المسافة الإجمالية',
      pickupStep: 'قل',
      dropoffStep: 'إنزال',
      routeProposed: 'المسار المقترح',
      stepLabel: 'المرحلة',
      taxiFullShort: 'مكتمل',
      seat: 'مقعد',
      seats: 'مقاعد',
      match: 'تطابق',
      matches: 'تطابقات',
      gateTitle: 'فضاء السائق',
      gateSubtitle: 'الدخول مخصص لسائقي شوف',
      gatePhoneLabel: 'رقم الهاتف',
      gatePhonePlaceholder: '06 12 34 56 78',
      gateRefCodeLabel: 'رمز المرجع الخاص بك',
      gateOpenWhatsapp: 'فتح واتساب',
      gateLogout: 'تسجيل الخروج',
      gateNote: 'اضغط على زر واتساب لتأكيد طلب الدخول.',
    },
    pwa: {
      installApp: 'تثبيت التطبيق',
      installTitle: 'تثبيت تطبيق شوف',
      installSubtitle: 'إضافة إلى الشاشة الرئيسية على هاتفك',
      installBtn: 'تثبيت',
      addToHome: 'إضافة إلى الشاشة الرئيسية',
      howToInstall: 'كيفية تثبيت شوف على الهاتف:',
      step1: 'اضغط على النقاط الثلاث (⋮) في أعلى يمين كروم.',
      step2: 'اختر "إضافة إلى الشاشة الرئيسية" أو "تثبيت".',
